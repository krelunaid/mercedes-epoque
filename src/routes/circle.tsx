    ...
    <Shell>
      <div className="text-center">
        ...
        <p className="mx-auto mt-3 max-w-md text-sm text-muted">
          Calendario ufficiale. Date e luoghi dai siti degli organizzatori — niente raduni inventati.
        </p>
      </div>
      ...
      <div className="mt-10 flex items-center justify-between gap-4 rounded-2xl bg-elevated px-5 py-5 shadow-[var(--shadow-gold)]">
        <div>
